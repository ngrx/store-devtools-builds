...
export var RECOMPUTE_STATE = '@ngrx/devtools/recompute-state';
export var RECOMPUTE_STATE_ACTION = { type: RECOMPUTE_STATE };
/**
        ...
        switch (liftedAction.type) {
            ...
            case UPDATE: {
                ...
                if (stateHasErrors) {
                    ...
                    computedStates = computedStates.map(function (cmp) { return (__assign({}, cmp, { state: reducer(cmp.state, RECOMPUTE_STATE_ACTION) })); });
